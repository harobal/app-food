...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    "/knowledge/pulses",
    "/knowledge/spices",
    "/knowledge/nuts-dried-fruits",
    "/knowledge/oilseeds-oils",
    "/knowledge/dehydrated-processed",
    "/knowledge/fresh-fruits",
    "/knowledge/fresh-vegetables",
    "/knowledge/sweeteners",
    "/knowledge/grains",
    "/knowledge/tea",
    "/knowledge/coffee",
    "/knowledge/processed-plant-foods",
  ].map((route) => ({
    url: `${baseUrl}${route}`,
    lastModified,
